...
local active_color = os.getenv("color1")
local inactive_color = os.getenv("color2")
...
hl.bind(mainMod .. " + Control_L + H",  hl.dsp.window.move({ x = 5, y = 0 }))
hl.bind(mainMod .. " + Control_L + L", hl.dsp.window.move({ x = 5, y = 0 }))
hl.bind(mainMod .. " + Control_L + K",    hl.dsp.window.move({ x = 0, y = 5 }))
hl.bind(mainMod .. " + Control_L + J",  hl.dsp.window.move({ x = 0, y = 5 }))
